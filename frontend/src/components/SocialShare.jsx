...
const SocialShare = ({ url, title, description, className = "" }) => {
  ...
  const shareTitle = title || document.title || "GovtHostelCare - Modern Hostel Management";
  const shareDescription = description || "Comprehensive digital hostel management platform for government hostels";
